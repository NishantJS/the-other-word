    ...
    <Root>
      ...
      >
        ...
        {playersFixedOrderWithOffset.map((player) => {
          ...
          // Get avatar URL and display name from player info
          const avatarUrl = player.info?.avatarUrl || '/images/default-avatar.svg'
          const displayName = player.info?.displayName || 'Player'
